    ...
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 lg:pt-48 lg:pb-40 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="hero-img-group relative pb-6 pr-6 lg:pb-8 lg:pr-8">
          ...
          <span aria-hidden="true" className="hero-bubble absolute w-6 h-6 hidden sm:block" style={{ bottom:"1.5rem",right:"4rem",  "--delay":"-1.3s",  "--dur":"1.6s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-4 h-4 hidden sm:block" style={{ bottom:"2.5rem",right:"6rem",  "--delay":"-0.2s",  "--dur":"1.8s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-2 h-2 hidden md:block" style={{ bottom:"5rem",  left:"6rem",   "--delay":"-0.7s",  "--dur":"2.2s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-4 h-4 hidden md:block" style={{ bottom:"1rem",  left:"33%",    "--delay":"-1.5s",  "--dur":"1.9s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-3 h-3 hidden md:block" style={{ bottom:"3rem",  left:"50%",    "--delay":"-0.5s",  "--dur":"2.1s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-2 h-2 hidden md:block" style={{ bottom:"6rem",  right:"2rem",  "--delay":"-0.9s",  "--dur":"2.3s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-3 h-3 hidden md:block" style={{ bottom:"0.5rem",right:"33%",   "--delay":"-1.6s",  "--dur":"2.0s" } as React.CSSProperties} />
          <span aria-hidden="true" className="hero-bubble absolute w-5 h-5 hidden md:block" style={{ bottom:"4rem",  left:"66%",    "--delay":"-0.8s",  "--dur":"1.7s" } as React.CSSProperties} />
